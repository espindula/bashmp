...
Direitos autorais (Copyright) da versão mudada traduzida para o idioma português escrito e falado no Brasil: (c) 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025 Jamenson Ferreira Espindula de Almeida Melo.
  ...
  documento sob os termos da Licença GNU de Documentação Livre, Versão 
...
2. Página de Manual (Man Page) (aqui traduzido).


 Além desses, o GNU Bash usa as seguintes bibliotecas (as quais 
 também tem as respectivas documentações delas):
